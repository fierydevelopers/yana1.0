...
<div class="flex-container">
        <div>
            <div class="col-md-6 col-sm-3 heart">
        ...
        <p style="left: 40%; padding-left: 30px">You Are Not Alone</p>
</div>

<li><a href="/policePP" id="loader">get support</a></li>
